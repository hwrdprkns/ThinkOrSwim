...
PLOT GMMA10 = EXPAVERAGE(Close,EMA1);
PLOT GMMA11 = EXPAVERAGE(Close,EMA1);
PLOT GMMA12 = EXPAVERAGE(Close,EMA1);
...
GMMA7.SETDEFAULTCOLOR(GETCOLOR(2));
GMMA8.SETDEFAULTCOLOR(GETCOLOR(2));
GMMA9.SETDEFAULTCOLOR(GETCOLOR(2));
GMMA10.SETDEFAULTCOLOR(GETCOLOR(2));
GMMA11.SETDEFAULTCOLOR(GETCOLOR(2));
GMMA12.SETDEFAULTCOLOR(GETCOLOR(2));