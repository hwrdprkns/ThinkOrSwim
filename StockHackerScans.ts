...
VOLUMEAVG(LENGTH = 20)[2] > VOLUMEAVG(LENGTH = 20)[3]
OR
...
##################################################################
# SWING BOX BREAKOUT
(CLOSE > HIGHEST(DATA = CLOSE, LENGTH = 2)[1]) AND #OR
#CLOSE < LOWEST(DATA = CLOSE, LENGTH = 2)[1]) 
VOLUMEAVG(LENGTH = 20) > VOLUMEAVG(LENGTH = 20).VOLAVG
##################################################################