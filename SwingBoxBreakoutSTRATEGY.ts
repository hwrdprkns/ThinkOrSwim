...
DEF TARGET = HIGH > ROLLINGLOW + ATRWILDER() * ATR;
DEF EXIT = TARGET IS TRUE OR STOPLOSS IS TRUE;

DEF SHARES = ROUND(10000 / CLOSE);

#LONG POSITION:
ADDORDER(ORDERTYPE.BUY_TO_OPEN, ENTRY IS TRUE, TRADESIZE = SHARES, TICKCOLOR = GETCOLOR(0), ARROWCOLOR = GETCOLOR(0), NAME = "LE", PRICE = OPEN);
