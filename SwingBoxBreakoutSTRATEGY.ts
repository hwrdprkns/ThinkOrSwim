...
DEF BUYSIGNAL = VOLUMEAVG(LENGTH = AVGVOL) > VOLUMEAVG(LENGTH = AVGVOL).VOLAVG AND SLOWLINE <= OVER_BOUGHT AND FASTLINE > FASTLINE[1] AND CLOSE>CLOSE[1] AND CLOSE >= CLOSE[90]-(CLOSE[90]*.15);
