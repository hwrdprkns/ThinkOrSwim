...
DEF MCO = (MCCLELLANOSCILLATOR()>0 OR (MCCLELLANOSCILLATOR() > ((MCCLELLANOSCILLATOR()[1]+MCCLELLANOSCILLATOR()[2])/2) AND CORRELATION(CLOSE, CLOSE("SPX"), 10)>0)) OR CORRELATION(CLOSE, CLOSE("SPX"), 10)<=0;
