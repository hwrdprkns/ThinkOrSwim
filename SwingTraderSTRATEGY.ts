...
ADDORDER(ORDERTYPE.SELL_TO_CLOSE, TARGET IS TRUE, TRADESIZE = SHARES, TICKCOLOR = GETCOLOR(1), ARROWCOLOR = GETCOLOR(1), NAME = "LX_LMT", PRICE = HIGH);
ADDORDER(ORDERTYPE.SELL_TO_CLOSE, STOPLOSS IS TRUE, TRADESIZE = SHARES, TICKCOLOR = GETCOLOR(1), ARROWCOLOR = GETCOLOR(1), NAME = "LX_STP", PRICE = low()[1]);
