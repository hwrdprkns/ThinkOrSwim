...
INPUT TARGET_ONE = 20; #1
INPUT TARGET_TWO = 40; #10
...
HIGH_ONE.SETPAINTINGSTRATEGY(PAINTINGSTRATEGY.HORIZONTAL);
HIGH_TWO.SETDEFAULTCOLOR(CREATECOLOR(255, 255, 255));
HIGH_TWO.SETPAINTINGSTRATEGY(PAINTINGSTRATEGY.HORIZONTAL);
HIGH_THR.SETDEFAULTCOLOR(CREATECOLOR(255, 255, 255));
HIGH_THR.SETPAINTINGSTRATEGY(PAINTINGSTRATEGY.HORIZONTAL);

LOW_ONE.SETDEFAULTCOLOR(CREATECOLOR(255, 255, 255));
LOW_ONE.SETPAINTINGSTRATEGY(PAINTINGSTRATEGY.HORIZONTAL);
LOW_TWO.SETDEFAULTCOLOR(CREATECOLOR(255, 255, 255));
LOW_TWO.SETPAINTINGSTRATEGY(PAINTINGSTRATEGY.HORIZONTAL);
LOW_THR.SETDEFAULTCOLOR(CREATECOLOR(255, 255, 255));
LOW_THR.SETPAINTINGSTRATEGY(PAINTINGSTRATEGY.HORIZONTAL);
